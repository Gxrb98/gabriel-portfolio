...
const About = () => {
    ...
    return (
        <div id="about" className="text-white py-1 bg-secondary rounded-md overflow-x-hidden mx-[1rem]">
            <div className="md:m-5 m-5 md:mx-4 ">
                <h1 className="md:text-3xl text-center text-xl text-title font-bold">{t('about.title')}</h1>
                <p className="mt-4 md:text-lg">{t('about.paragraph1')} <br /> {t('about.paragraph2')} <br />{t('about.paragraph3')}</p>
            </div>
            <div className="md:flex md:justify-between md:mt-7 m-5 md:mx-4 ">
                <div>
                    <h1 className="text-xl text-title md:text-3xl font-bold">{t('about.title1')}</h1>
                    <div>
                        <p>{t('about.subtitle')}</p>
                        <p className="italic">{t('about.subtitle1')}</p>
